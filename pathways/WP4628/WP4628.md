...
description: 'Glycolysis is the metabolic pathway that converts glucose C6H12O6, into
  ...
  the original computer model.  A second version, only containing the content of the
  model itself, can be found here [https://www.wikipathways.org/index.php/Pathway:WP4629].  This
...
- '@context': https://schema.org/
  ...
  description: 'Glycolysis is the metabolic pathway that converts glucose C6H12O6,
    ...
    may differ from the original computer model.  A second version, only containing
    the content of the model itself, can be found here [https://www.wikipathways.org/index.php/Pathway:WP4629].  This
    pathway was uploaded to provide a high resolution version to readers of the thesis.
    Description and pathway adapted from [https://www.wikipathways.org/index.php/Pathway:WP534]
    Referred article: [https://www.ncbi.nlm.nih.gov/pubmed/25009227 Shestov et al.,
    2014]'
