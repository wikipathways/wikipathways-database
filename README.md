...
If you want to make edits to a pathway at WikiPathways, DO NOT create pull requests directly for this repo WITHOUT first consulting senior editors. In the current transition phase, this is the temporary solution. Later on, when PathVisio is fully updated (summer 2026), use the PathVisio tool with the WikiPathways plugin to edit existing pathways and contribute new pathways.
